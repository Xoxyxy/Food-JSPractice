function calculator() {
  ...
  const initLS = (selector, activeClass) => {
  ...
  initLS('#gender div', 'calculating__choose-item_active')
  initLS('.calculating__choose_big div', 'calculating__choose-item_active')

  const calcTotal = () => {
    if (!sex || !height || !weight || !age || !ratio) {
      result.innerHTML = 'Знач.'
      return
    }
